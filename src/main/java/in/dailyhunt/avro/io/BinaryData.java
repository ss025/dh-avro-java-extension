...
public class BinaryData {
   ...
   * in.dailyhunt.avro.generic.GenericData#compare(Object, Object, Schema)}.*/
  ...
  private static int compare(Decoders d, Schema schema) throws IOException {
    ...
    case SET:
        throw new AvroRuntimeException("Can't compare sets!");
    case MAP:
   ...
   * in.dailyhunt.avro.generic.GenericData#hashCode(Object, Schema)}.*/
  ...
  private static int hashCode(HashData data, Schema schema)
    ...
    case SET:
        throw new AvroRuntimeException("Can't hashCode sets!");
    case MAP:
